...
for cam in CAMERAS:
    ...
    set_values += [
        # 640->1280 (2026-07-26): 검출/depth 샘플링 정확도를 위해 해상도 상향
        # (손목 RSD455 RenderProduct도 동일하게 1280으로 맞춰둠, bump_camera_res.py 참고).
        (f"{render_product}.inputs:width", 1280),
        (f"{render_product}.inputs:height", 1280),
