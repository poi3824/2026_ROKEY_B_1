...
AMR_STATION_POSES = {
    "station_1": {
        "battery": ("battery1", X_BATTERY, -1.1478, 0.0),
        "busbar": ("busbar1", -1.1298, Y_BUSBAR, 0.0),
    },
    "station_2": {
        "battery": ("battery2", X_BATTERY, -0.5457, 0.0),
        "busbar": ("busbar2", -0.6606, Y_BUSBAR, 0.0),
    },
    "station_3": {
        "battery": ("battery3", X_BATTERY, 0.0117, 0.0),
